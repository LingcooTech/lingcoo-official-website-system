...
CREATE INDEX IF NOT EXISTS "inquiries_assigned_status_idx" ON "inquiries" ("assigned_to", "status");
...
INSERT INTO "presentation_profiles" (
  ...
  'default', 'LingcooTech', 'LingcooTech', '让复杂系统，清晰生长', '#16362c', '#d7eee4', '#1f7a5a',
  'hello@lingcoo.com', 'https://www.lingcoo.com', 'LingcooTech · 轻量、自有、可持续演进的数字系统',
  'LingcooTech 面向教育、零售与组织运营场景，设计并交付轻量、自有、可快速部署的数字系统。',
